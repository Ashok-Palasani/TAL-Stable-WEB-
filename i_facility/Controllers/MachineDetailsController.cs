...
namespace i_facility.Controllers
{
    public class MachineDetailsController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewData["NestedMachine"] = tblmachine.IsNestedSheetMachine;
            ...
            if (Request.Files["file"].ContentLength > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        //cmd2 = new SqlCommand("INSERT INTO tblmachinedetails(InsertedBy,InsertedOn," +
