    ...
    public class OEEDashboardController : Controller
    {
        ...
        public ActionResult Index(int PlantID = 0, int ShopID = 0, int CellID = 0, int WorkCenterID = 0, string StartDate = null, string EndDate = null, string SummarizeAs = null, string ButtonClicked = null)
        {
            ...
            if (!dateError)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        obj.deletetbloeedashboardvariablestodaysDetails2(machData[0].IPAddress.ToString());
                        //dboee.tbloeedashboardvariablestodays.RemoveRange(dboee.tbloeedashboardvariablestodays.Where(x => x.IPAddress == ipAddress));
                        //dboee.SaveChanges();
                    }
                    catch (Exception e)
                    ...
                    try
                    {
                        obj.deletetbloeedashboardfinalvariablesDetails2(machData[0].IPAddress);
                        //dboee.tbloeedashboardfinalvariables.RemoveRange(dboee.tbloeedashboardfinalvariables.Where(x => x.IPAddress == ipAddress));
                        //dboee.SaveChanges();
                    }
                    catch (Exception e)
                    ...
                    if (OEEDataSummarizedToView != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where CellID = " + CellID + "  and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                        ...
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                     "(" +
                                                     "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where CellID = " + CellID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where CellID = " + CellID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where CellID = " + CellID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where CellID = " + CellID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     "Union All " +
                                                     "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where CellID = " + CellID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                     ") f order by f.lossname desc";
                        }
                ...
                if (lowestLevel == "Shop")
                {
                    ...
                    if (OEEDataSummarizedToViewShop != null)
                    {
                        ...
                        if (TimingVar != "Today")
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                 "(" +
                                                 "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 "Union All " +
                                                 "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                 ") f order by f.lossname desc";
                        }
                        else
                        {
                            GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                                "(" +
                                                "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                "Union All " +
                                                "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where ShopID = " + ShopID + " and StartDate Between '" + frmDate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + toDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                                ") f order by f.lossname desc";
                        }
                        DataTable GetDistinctLossDT = new DataTable();
                        using (MsqlConnection mc = new MsqlConnection())
            ...
            if (PlantID != 0)
            {
                if (CellID != 0)
                {
                    ...
                    if (WorkCenterID != 0)
                    {
                        ...
                        ViewBag.SelectedPath = additionToPath + " => "+ plantName + " => " + shopName + " => " + cellName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                ...
                else
                {
                    ...
                    if (WorkCenterID != 0)
                    {
                        var wcName = obj.GettbMachineDet(WorkCenterID);
                        //string wcName = db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.MachineID == WorkCenterID).Select(m => m.MachineInvNo).FirstOrDefault();
                        ViewBag.SelectedPath = additionToPath + " => " + plantName + " => " + shopName + " => " + wcName.MachineInvNo + " From: " + frmDate.ToString("yyyy-MM-dd") + " To: " + toDate.ToString("yyyy-MM-dd");
                        ViewData["WorkCenterID"] = new SelectList(obj.GetmachineList(PlantID, ShopID, WorkCenterID), "MachineID", "MachineInvNo");
                        //ViewData["WorkCenterID"] = new SelectList(db.tblmachinedetails.Where(m => m.IsDeleted == 0 && m.PlantID == PlantID && m.ShopID == ShopID && m.IsNormalWC == 0), "MachineID", "MachineInvNo");
                    }
                    else
        ...
        public void CalculateSummarizedOEEPlant(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var PlantRow in getPlant)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where PlantID = " + PlantRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
        ...
        public void CalculateSummarizedOEEShop(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var ShopRow in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where ShopID = " + ShopRow.ShopID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where ShopID = " + ShopRow.ShopID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where ShopID = " + ShopRow.ShopID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where ShopID = " + ShopRow.ShopID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where ShopID = " + ShopRow.ShopID + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var Row in getShop)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where ShopID = " + ShopRow + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
        ...
        public void CalculateSummarizedOEECell(DateTime fromdate, DateTime todate, int FactorID, string TimeType, string SummarizeAs = null)
        {
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var CellRow in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var Row in getCell)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where CellID = " + id + " and StartDate Between '" + fromdate.ToString("yyyy-MM-dd HH:mm:ss") + "' AND '" + todate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
        ...
        public int GetMinorLossesToday(string CorrectedDate, String StartTime, String EndTime, int MachineID, string Colour)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                //mc.close();
                mc.open();
                String GetMinorLossNew = "SELECT SUM(DurationInSec) from " + MsqlConnection.DbName + ".[tbllivemodedb] where MachineID = " + MachineID +" and IsDeleted = 0 and CorrectedDate = '" + CorrectedDate + "' and ColorCode = '" + Colour + "' and DurationInSec < 120  and IsCompleted = 1;";
        ...
        public int GetOPIDleBreakDownToday(string CorrectedDate, String StartTime, String EndTime, int MachineID, string Colour)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                mc.open();
                String GetDurationQuery = "SELECT SUM(DurationInSec) from " + MsqlConnection.DbName + ".[tbllivemodedb] where MachineID = " + MachineID + " and IsDeleted = 0 and CorrectedDate = '" + CorrectedDate + "' and ColorCode = '" + Colour + "' and IsCompleted = 1;";
                SqlDataAdapter GetDurationDA = new SqlDataAdapter(GetDurationQuery, mc.msqlConnection);
                GetDurationDA.Fill(OP);
                mc.close();

                mc.open();
                String GetRunningDurationQuery = "SELECT StartTime from " + MsqlConnection.DbName + ".[tbllivemodedb] where MachineID = " + MachineID + " and IsDeleted = 0 and CorrectedDate = '" + CorrectedDate + "' and ColorCode = '" + Colour + "' and IsCompleted = 0;";
        ...
        {
            string res = "";
            var celldetails = (from s in db.tblmachinedetails where s.CellID == CellID && s.IsDeleted == 0 select new { Value = s.MachineID, Text = s.MachineInvNo }).ToList();
